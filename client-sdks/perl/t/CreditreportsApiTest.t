...
use_ok('WWW::SwaggerClient::CreditreportsApi');

my $api = WWW::SwaggerClient::CreditreportsApi->new();
isa_ok($api, 'WWW::SwaggerClient::CreditreportsApi');

#
# credit_reports_get test
#
{
    my $end_user_token = undef; # replace NULL with a proper value
    my $credit_report_id = undef; # replace NULL with a proper value
    my $format = undef; # replace NULL with a proper value
    my $result = $api->credit_reports_get(end_user_token => $end_user_token, credit_report_id => $credit_report_id, format => $format);
}

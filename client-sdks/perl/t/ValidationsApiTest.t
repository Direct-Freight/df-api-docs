...
use_ok('WWW::SwaggerClient::ValidationsApi');

my $api = WWW::SwaggerClient::ValidationsApi->new();
isa_ok($api, 'WWW::SwaggerClient::ValidationsApi');

#
# validations_email_exists_get test
#
{
    my $end_user_token = undef; # replace NULL with a proper value
    my $email = undef; # replace NULL with a proper value
    my $result = $api->validations_email_exists_get(end_user_token => $end_user_token, email => $email);
}

...
use_ok('WWW::SwaggerClient::BillingsApi');

my $api = WWW::SwaggerClient::BillingsApi->new();
isa_ok($api, 'WWW::SwaggerClient::BillingsApi');
...
#
{
    ...
    my $result = $api->billings_get(end_user_token => $end_user_token, promo_code => $promo_code);
}
...
#
{
    ...
    my $result = $api->billings_post(end_user_token => $end_user_token, body => $body);
}

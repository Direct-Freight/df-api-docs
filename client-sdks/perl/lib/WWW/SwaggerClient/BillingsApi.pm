...
#
package WWW::SwaggerClient::BillingsApi;
...
# @param string $promo_code The promo code.  (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'billings_get' } = { 
...
sub billings_get {
    ...
    unless (exists $args{'end_user_token'}) {
      croak("Missing the required parameter 'end_user_token' when calling billings_get");
    }

    # parse inputs
    my $_resource_path = '/billings';
    ...
    if ( exists $args{'promo_code'}) {
        $query_params->{'promo_code'} = $self->{api_client}->to_query_value($args{'promo_code'});
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('GetBillingResponse', $response);
...
# 
# @param string $end_user_token  (required)
# @param BillUser $body This function will attempt to process a payment, and upgrade a non subscibed user.  (required)
{
    my $params = {
    'end_user_token' => {
        data_type => 'string',
    ...
    __PACKAGE__->method_documentation->{ 'billings_post' } = { 
    	summary => 'This function will attempt to process a payment, and upgrade a non subscibed user. ',
        params => $params,
        returns => 'PostBillingResponse',
        };
}
# @return PostBillingResponse
#
sub billings_post {
    my ($self, %args) = @_;
    ...
    # verify the required parameter 'end_user_token' is set
    unless (exists $args{'end_user_token'}) {
      croak("Missing the required parameter 'end_user_token' when calling billings_post");
    }

    # verify the required parameter 'body' is set
    unless (exists $args{'body'}) {
      croak("Missing the required parameter 'body' when calling billings_post");
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('PostBillingResponse', $response);
    return $_response_object;
}

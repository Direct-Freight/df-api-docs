...
#
package WWW::SwaggerClient::Object::PostBoardTypeErrorResponse;
...
__PACKAGE__->class_documentation({description => '',
                                  class => 'PostBoardTypeErrorResponse',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    'bad_search_parameter' => {
    	datatype => 'object',
    	base_name => 'bad_search_parameter',
...
__PACKAGE__->swagger_types( {
    'bad_search_parameter' => 'object'
} );

__PACKAGE__->attribute_map( {
    'bad_search_parameter' => 'bad_search_parameter'
} );

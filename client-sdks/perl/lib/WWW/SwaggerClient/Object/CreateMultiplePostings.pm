...
#
package WWW::SwaggerClient::Object::CreateMultiplePostings;
...
__PACKAGE__->method_documentation({
    ...
    'delete_current_before_posting' => {
    	datatype => 'boolean',
    	base_name => 'delete_current_before_posting',
...
__PACKAGE__->swagger_types( {
    ...
    'delete_current_before_posting' => 'boolean',
    'list' => 'ARRAY[string]'
} );
...
__PACKAGE__->attribute_map( {
    ...
    'delete_current_before_posting' => 'delete_current_before_posting',
    'list' => 'list'
} );
